...
export const Sidebar = () => {
  return (
    <div
      id="menu"
      className="bg-gray-900 min-h-screen z-10 text-slate-300 w-[72px] md:w-[400px] shrink-0 left-0 overflow-y-auto"
    >
      ...
      <div id="profile" className="px-2 md:px-6 py-6 md:py-10">
        ...
        <a href="#" className="flex justify-center md:justify-start items-center md:space-x-2">
          <span>
            <Image
